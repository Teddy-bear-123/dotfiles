...
'-t+[Application theme]:THEME: ' \
'--theme=[Application theme]:THEME: ' \
'-c+[Path to the application'\''s config folder]:FOLDER: ' \
'--config-folder=[Path to the application'\''s config folder]:FOLDER: ' \
'-C+[Path to the application'\''s cache folder]:FOLDER: ' \
'--cache-folder=[Path to the application'\''s cache folder]:FOLDER: ' \
'-h[Print help]' \
'--help[Print help]' \
'-V[Print version]' \
...
(liked)
_arguments "${_arguments_options[@]}" \
'-l+[The limit for number of tracks to play]: : ' \
'--limit=[The limit for number of tracks to play]: : ' \
